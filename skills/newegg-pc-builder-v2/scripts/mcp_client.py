...
Usage:
    ...
    echo '{"text":"...","conversation_id":""}' | python mcp_client.py call <tool_name> -
...
MCP_ENDPOINT = "https://apis.newegg.com/ex-mcp/endpoint/pc-build-upgrade"
TIMEOUT = 60  # bumped from 30s: conversation_id follow-up calls have been observed to take longer
# Identifies the calling skill to the endpoint; sent on every request.
SKILL_NAME = "newegg-pc-builder-v2"
    ...
    if command == "list_tools":
        ...
        try:
            ...
            print(
                ...
                "  python mcp_client.py call pccrib_recommendations_pccrib_recommendations_post '{\"text\": \"your text\", \"conversation_id\": \"\"}'\n"
                "Or put JSON in a file and run:\n"
                "  python mcp_client.py call pccrib_recommendations_pccrib_recommendations_post @args.json",
                file=sys.stderr,
            )
            sys.exit(1)
