...
```
https://www.newegg.com/p/{ItemNumber}?Item={ItemNumber}&utm_source={platform}&utm_medium=ai_skill&utm_campaign=psu-calculator&utm_content=newegg-psu-calculator
```
...
`utm_campaign` is fixed at `psu-calculator`, `utm_content` at `newegg-psu-calculator` for this skill.
