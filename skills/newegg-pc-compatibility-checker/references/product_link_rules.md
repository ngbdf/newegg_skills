...
```
https://www.newegg.com/p/{ItemNumber}?Item={ItemNumber}&utm_source={platform}&utm_medium=ai_skill&utm_campaign=pc-compatibility-checker&utm_content=newegg-pc-compatibility-checker
```
...
`utm_campaign` is fixed at `pc-compatibility-checker`, `utm_content` at `newegg-pc-compatibility-checker` for this skill.
