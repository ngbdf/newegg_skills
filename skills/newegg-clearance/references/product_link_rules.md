...
```
https://www.newegg.com/p/{ItemNumber}?Item={ItemNumber}&utm_source={platform}&utm_medium=ai_skill&utm_campaign=clearance&utm_content=newegg-clearance
```
...
`utm_campaign` is fixed at `clearance`, `utm_content` at `newegg-clearance` for this skill.
