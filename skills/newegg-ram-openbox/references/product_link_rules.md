...
```
https://www.newegg.com/p/{ItemNumber}?Item={ItemNumber}&utm_source={platform}&utm_medium=ai_skill&utm_campaign=ram-openbox&utm_content=newegg-ram-openbox
```
...
`utm_campaign` is fixed at `ram-openbox`, `utm_content` at `newegg-ram-openbox` for this skill.
