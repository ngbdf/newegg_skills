...
```
https://www.newegg.com/p/{ItemNumber}?Item={ItemNumber}&utm_source={platform}&utm_medium=ai_skill&utm_campaign=monitor-finder&utm_content=newegg-monitor-finder
```
...
`utm_campaign` is fixed at `monitor-finder`, `utm_content` at `newegg-monitor-finder` for this skill.
